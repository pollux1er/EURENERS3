...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`productos_finales` (
  ...
  `emision_uso_co2` DECIMAL NULL ,
  `emision_uso_ch4` DECIMAL NULL ,
  `emision_uso_n2o` DECIMAL NULL ,
  `emision_uso_co2_eq` DECIMAL NULL ,
  `fuente_uso` VARCHAR(255) NULL ,
  `emision_distribucion_co2` DECIMAL NULL ,
  `emision_distribucion_ch4` DECIMAL NULL ,
  `emision_distribucion_n2o` DECIMAL NULL ,
  `emision_distribucion_co2_eq` DECIMAL NULL ,
  `fuente_distribucion` DECIMAL NULL ,
  `emision_comercio_co2` DECIMAL NULL ,
  `emision_comercio_ch4` DECIMAL NULL ,
  `emision_comercio_n2o` DECIMAL NULL ,
  `emision_comercio_co2_eq` DECIMAL NULL ,
  `fuente_comercio` DECIMAL NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`cultivos` (
  ...
  `categoria` INT NULL ,
  `nombre` VARCHAR(255) NULL ,
  `extraccion_kg_n` DECIMAL NULL ,
  `extraccion_kg_p` DECIMAL NULL ,
  `extraccion_kg_k` DECIMAL NULL ,
  `unidad` VARCHAR(50) NULL ,
  `mj` DECIMAL NULL ,
  `kg_ct` DECIMAL NULL ,
  `fracrenew` DECIMAL NULL ,
  `slope` DECIMAL NULL ,
  `intercept` DECIMAL NULL ,
  `nag` DECIMAL NULL ,
  `nbg` DECIMAL NULL ,
  `rbg_bio` DECIMAL NULL ,
  `materia_seca` DECIMAL NULL ,
  `residuo_cultivo` DECIMAL NULL ,
  `porcentaje_residuo` DECIMAL NULL ,
  `fuente` VARCHAR(255) NULL ,
  `fecha_baja` DATETIME NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
  `fecha_creacion` DATETIME NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`animales` (
  ...
  `categoria` INT NULL ,
  `nombre` VARCHAR(255) NULL ,
  `peso_medio` DECIMAL NULL ,
  `porcentaje_n` DECIMAL NULL ,
  `porcentaje_p` DECIMAL NULL ,
  `porcentaje_k` DECIMAL NULL ,
  `mj_peso_vivo` DECIMAL NULL ,
  `ugm` DECIMAL NULL ,
  `fermentacion` DECIMAL NULL ,
  `fuente` VARCHAR(255) NULL ,
  `fecha_baja` DATETIME NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
  `fecha_creacion` DATETIME NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`instalaciones` (
  ...
  `categoria` INT NULL ,
  `nombre` VARCHAR(255) NULL ,
  `mjul_m2` DECIMAL NULL ,
  `amortizacion` DECIMAL NULL ,
  `material` VARCHAR(255) NULL ,
  `emision_co2` DECIMAL NULL ,
  `emision_n2o` DECIMAL NULL ,
  `emision_ch4` DECIMAL NULL ,
  `emision_co2_eq` DECIMAL NULL ,
  `unidad` VARCHAR(50) NULL ,
  `fuente` VARCHAR(255) NULL ,
  `fecha_baja` DATETIME NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`maquinarias` (
  ...
  `emision_co2_material` DECIMAL NULL ,
  `peso_standard` DECIMAL NULL ,
  `antiguedad` DECIMAL NULL ,
  `vida_util` DECIMAL NULL ,
  `horas` DECIMAL NULL ,
  `has` DECIMAL NULL ,
  `mj_kg` DECIMAL NULL ,
  `emision_co2` DECIMAL NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`labores` (
  ...
  `mjul_ha` DECIMAL NULL ,
  `unidad` VARCHAR(50) NULL ,
  `mj_kg_material` DECIMAL NULL ,
  `fuente` VARCHAR(255) NULL ,
  `fecha_baja` DATETIME NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
  `fecha_creacion` DATETIME NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`productos` (
  ...
  `fijacion_c` DECIMAL NULL ,
  `valor_energetico` DECIMAL NULL ,
  `extraccion_kg_n` DECIMAL NULL ,
  `extraccion_kg_p` DECIMAL NULL ,
  `extraccion_kg_k` DECIMAL NULL ,
  `unidad` VARCHAR(50) NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`empresa_animales` (
  ...
  `es_transformacion` TINYINT NULL ,
  `numero` DECIMAL NULL ,
  `dias_en_explotacion` DECIMAL NULL ,
  `ciclos_plaza` DECIMAL NULL ,
  `porcentaje_pastoreo` DECIMAL NULL ,
  `emision_co2` DECIMAL NULL ,
  `emision_ch4` DECIMAL NULL ,
  `emision_n2o` DECIMAL NULL ,
  `emision_co2_eq` DECIMAL NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`empresa_productos_resultantes` (
  ...
  `cantidad` DECIMAL NULL ,
  `rendimiento` DECIMAL NULL ,
  `fraccion_comercial` DECIMAL NULL ,
  `porcentaje_rastrojo` DECIMAL NULL ,
  `porcentaje_quema` DECIMAL NULL ,
  `fecha_baja` DATETIME NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
  `fecha_creacion` DATETIME NULL ,
  `usuario_ultima_modificacion` VARCHAR(50) NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`empresa_animales_pastoreo` (
  ...
  `julio` DECIMAL NULL ,
  `agosto` DECIMAL NULL ,
  `septiembre` DECIMAL NULL ,
  `octubre` DECIMAL NULL ,
  `noviembre` DECIMAL NULL ,
  `diciembre` DECIMAL NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
  `fecha_creacion` DATETIME NULL ,
  `usuario_ultima_modificacion` VARCHAR(50) NULL ,
  `fecha_ultima_modificacion` DATETIME NULL ,
...
CREATE  TABLE IF NOT EXISTS `eureners_cimanti`.`provincias_animales_excreta` (
  `provincia` INT NOT NULL ,
  `animal` INT NOT NULL ,
  `porcentaje_excreta` DECIMAL NULL ,
  `fuente` VARCHAR(255) NULL ,
  `usuario_creacion` VARCHAR(50) NULL ,
  `fecha_creacion` DATETIME NULL ,
  `usuario_ultima_modificacion` VARCHAR(50) NULL ,
