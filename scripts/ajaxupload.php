...
<?php
	if($imgUploaded){
		...
		ajax_inclusion('project');
		$p = new project; 
		$p->saveLogo($upload_image);
		echo '<div style="position: relative;z-index : 10px;color:white;"><div style="position:absolute; z-index:-1; top:0; left:0; right:0; bottom:0; opacity:0.2;"></div><br /><img src="images/success.gif" width="16" height="16" border="0" style="marin-bottom: -4px;" /> Success!<br /><br /><br /><img src="'.$upload_image.'" border="3" height="150" /></div>';
	}else{
