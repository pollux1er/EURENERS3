...
class  empresa_animales_pastoreo extends entity {
	...
	public function update($updates, $table = null) {
		...
		if(is_null($this->getRecordE($updates['animal']))) {
			//
			$updates['empresa'] = $_SESSION['u']['enterprise'];
			//var_dump($updates); die;
			$res = $this->newRecord($updates);
		} else {
