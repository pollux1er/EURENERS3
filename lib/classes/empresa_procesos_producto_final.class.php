...
class empresa_procesos_producto_final extends entity {
	...
	public function getAllProcessFromProduct($ip) {
		$req = "SELECT * FROM $this->table WHERE producto_final = '$ip' AND empresa = '".$_SESSION['u']['enterprise']."';";
		$res = $this->select($req);
		return $res;
	}
