		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_installations'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->instalacion; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_installations&instalacion=<?php echo $m->instalacion; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
