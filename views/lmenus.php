...
<div class="section">
		<div class="full">
			<div class="box">
				<div class="title">
					<h2>List of Menus</h2>
					<span onclick="window.location='?view=menu'" class="add">Add</span>
				</div>
				<div class="content">
					<table cellspacing="0" cellpadding="0" border="0" class="all"> 
						...
						<?php foreach($menus as $m) { ?>
							<tr id="<?php echo $m->identificador; ?>"> 
								...
								<td><a href="#"><?php echo $m->identificador; ?></a></td>
								<td><a href="#"><?php echo $m->nombre; ?></a></td>
								<td><?php echo $m->descripcion; ?></td>
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=menu&id=<?php echo $m->identificador; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
