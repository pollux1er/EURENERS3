		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_wt'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->identificador; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_wt&id=<?php echo $m->identificador; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
									...
									<a style="margin-left:2px;float:left" title="Tratamiento" href="?view=lproc_tratamiento&empresa_residuo=<?php echo $m->identificador; ?>"><img src="images/icons/recycle_bin_full.png" alt="delete" /></a>
									<a style="margin-left:2px;float:left" title="Transporte" href="?view=lproc_transporte&empresa_residuo=<?php echo $m->identificador; ?>"><img height="20" src="images/icons/truck.png" alt="delete" /></a>
								</td>
							</tr>
						<?php } ?> 
						</tbody> 
