...
$culti = $cultivo->getCultivosOfEmpresa();
						...
						<div id="lesinputs users">
							<div class="finput" id="btip">
								...
								<select id="cultivo" name="cultivo">
									<option value="">Select Cultivo</option>
							...
							<div class="nextline">
								...
								<div class="sfinput">
									<label >Unidad</label>
									<input id="unidad" type="text" name="unidad" class="small" readonly="readonly" value="<?php echo $mic->unidad; ?>" />
								</div>
								<div class="finput" id="btip">
...
$(function(){
  ...
  $("select#cultivo").change(function(){
    $.getJSON("_ajax/getUnidadFromCultivo.php",{id: $(this).val(), ajax: 'true'}, function(obj){
