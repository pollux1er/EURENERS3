		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_energy'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->energia; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_energy&energia=<?php echo $m->energia; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
