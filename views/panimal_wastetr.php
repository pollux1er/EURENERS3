...
$culti = $cultivo->getAnimalesOfEmpresa();
...
<div class="formulaire users">
	<div class="box">
		<div class="title">
			...
			<span onclick="window.location='?view=lpanimal_wastetr'" class="add">List</span>
		</div>
...
$(function(){
  ...
  $("select#residuo").change(function(){
   ...
   $("select#animal").change(function(){
    $.getJSON("_ajax/getUnidadFromAnimal.php",{id: $(this).val(), ajax: 'true'}, function(obj){
