...
<div class="section">
		<div class="full">
			<div class="box">
				<div class="title">
					<h2>List of Wastes Threatments</h2>
					<span onclick="window.location='?view=waste-tr'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?>
							<tr id="<?php echo $m->identificador; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=waste-tr&id=<?php echo $m->identificador; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
									<a style="margin-left:2px;float:left" href="#" onclick=" deletetratamientos('<?php echo $m->identificador; ?>')"><img src="gfx/icon-delete.png" alt="delete" /></a>
								</td>
							</tr>
						<?php } ?> 
						</tbody> 
