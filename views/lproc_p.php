<?php
	...
	$menus = $menu->getAllProcessFromProduct($_GET['producto_final']);	
	//global $lang;
...
<div class="section">
		<div class="full">
			<div class="box">
				<div class="title">
					<h2>List of Transformacion for product <?php echo utf8_encode($menu->getName($_GET['producto_final'], 'productos_finales')); ?></h2>
					<span onclick="window.location='?view=lproc_pp'" class="addy">Back to product</span>
					<span onclick="window.location='?view=proc_p&producto_final=<?php echo $_GET['producto_final']; ?>'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->proceso_transformacion . '-' . $m->producto_final; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_p&proceso_transformacion=<?php echo $m->proceso_transformacion; ?>&producto_final=<?php echo $m->producto_final ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
