		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_tratamiento&empresa_residuo=<?php echo $_GET['empresa_residuo']; ?>'" class="add">Add</span>
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->residuo.'-'.$m->tratamiento_residuo; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_tratamiento&empresa_residuo=<?php echo $m->residuo; ?>&tratamiento=<?php echo $m->tratamiento_residuo ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
