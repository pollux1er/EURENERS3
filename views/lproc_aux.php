		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_aux'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->servicio_auxiliar; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_aux&servicio_auxiliar=<?php echo $m->servicio_auxiliar; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
