...
<div class="formulaire users">
	<div class="box">
		<div class="title">
			...
			<span onclick="window.location='?view=lpcrop_transporte&empresa_residuo=<?php echo $_GET['empresa_residuo'] ?>'" class="add">List</span>
		</div>
					...
					<div id="lesinputs users">
						...
						<legend>Transporte of Gestar</legend>
							...
							<div class="line">
								<div class="finput">
									<label >Unidad</label>
									<input id="unidad" type="text" name="unidad" READONLY="readonly" class="small" value="<?php echo $mic->unidad; ?>" />
								</div>
								<div class="finput">
									<label >Fuente</label>
