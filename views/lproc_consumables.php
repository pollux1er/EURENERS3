		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_consumables'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="c<?php echo $m->consumible; ?>m<?php echo $m->maquinaria; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_consumables&consumible=<?php echo $m->consumible; ?>&maquinaria=<?php echo $m->maquinaria; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
