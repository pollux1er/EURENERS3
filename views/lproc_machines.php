<?php
	...
	$menus = $menu->getAllRecordsETrans();	
	//global $lang;
		...
		<div class="full">
			<div class="box">
				<div class="title">
					...
					<span onclick="window.location='?view=proc_machines'" class="add">Add</span>
				</div>
				<div class="content">
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->maquinaria; ?>"> 
								...
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=proc_machines&maquinaria=<?php echo $m->maquinaria; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
									<a style="margin-left:2px;float:left" href="#" onclick="deleteCrop('<?php echo $m->maquinaria; ?>')"><img src="gfx/icon-delete.png" alt="delete" /></a>
								</td>
							</tr>
						<?php } ?> 
						</tbody> 
