...
<div class="section">
		<div class="full">
			<div class="box">
				<div class="title">
					<h2>List of Energias</h2>
					<span onclick="window.location='?view=energy'" class="add">Add</span>
				</div>
				<div class="content">
					<table cellspacing="0" cellpadding="0" border="0" class="all"> 
						...
						<?php foreach($menus as $m) { ?> 
							<tr id="<?php echo $m->identificador; ?>"> 
								...
								<td><?php echo utf8_encode($m->unidad); ?></td>
								<td><?php echo utf8_encode($menu->getName($m->categoria, 'categorias')); ?></td>
								<td><?php echo utf8_encode($m->fuente); ?></td>
								<td style="padding:5px 4px;">
									<a style="float:left" href="?view=energy&id=<?php echo $m->identificador; ?>"><img src="gfx/icon-edit.png" alt="edit" /></a>
									<a style="margin-left:2px;float:left" href="#" onclick="deleteEn('<?php echo $m->identificador; ?>')"><img src="gfx/icon-delete.png" alt="delete" /></a>
								</td>
							</tr>
						<?php } ?> 
						</tbody> 
